...
public class UserReq {
    ...
    @Pattern(regexp = ApplicationConstants.PASSWORD_REGEX, message = "Password should contain at least 1 uppercase, 1 lowercase, 1 number, 1 special character and should be of minimum 8 characters")
