    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        if (null != jwt) {
            try {
                ...
                Map<String, Object> map = (Map<String, Object>) claims.get("userSessionBean");
                UserSessionBean userSessionBean = UserSessionBean.builder()
                ...
                authentication.setDetails(userSessionBean);
